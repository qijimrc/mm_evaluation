...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='msvrvtt_qa')
    ...
    vqas = load_dataset(
        qa_path='/data/qiji/video_dataset/msrvtt/test_qa.json',
        video_dir='/data/qiji/video_dataset/msrvtt/videos/'
    )
